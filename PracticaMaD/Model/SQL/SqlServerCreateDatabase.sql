INSERT INTO Client (clientLogin,clientPassword,firstName,firstSurname,lastSurname,clientAddress,email, clientLanguage, rol) VALUES ('DigoStorm','1234','Diego','Villanueva','Farina','Mi Casa','d@udc.es','Español', 'Cliente');
INSERT INTO Client (clientLogin,clientPassword,firstName,firstSurname,lastSurname,clientAddress,email, clientLanguage, rol) VALUES ('Jacojh21','1234','Jacobo','Jorge','Hermida','Su Casa','j@udc.es','Español', 'Admin');
