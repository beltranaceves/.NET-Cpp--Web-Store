...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder_BodyContent" runat="server">
    ...
    <span>
        ...
        <asp:GridView ID="gvShoppingCart"  runat="server" 
            ...
            <asp:BoundField DataField="productName" HeaderText="productName" Visible="true" meta:resourcekey="BoundFieldResource17" />
            ...
            <asp:BoundField DataField="totalPrice" HeaderText="totalPrice" Visible="true" meta:resourcekey="BoundFieldResource17" />
